...
\\000"
 ...
 (1, 
"\003\003\003\003\003\003\003\003\003\018\022\003\003\020\003\003\
\\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003\
\\018\003\003\003\003\015\003\003\014\013\003\003\012\010\003\003\
\\009\009\009\009\009\009\009\009\009\009\003\003\003\008\003\003\
...
\\005\005\005\005\005\005\005\005\005\005\000\000\000\000\000\005\
...
\\007\007\007\007\007\007\007\007\007\007\000\000\000\000\000\007\
...
{fin = [], trans = 1},
{fin = [(N 37)], trans = 0},
{fin = [(N 30),(N 37)], trans = 4},
{fin = [(N 30)], trans = 4},
{fin = [(N 33),(N 37)], trans = 6},
{fin = [(N 33)], trans = 6},
{fin = [(N 23),(N 37)], trans = 0},
{fin = [(N 35),(N 37)], trans = 0},
{fin = [(N 37)], trans = 10},
{fin = [(N 19)], trans = 0},
{fin = [(N 21),(N 37)], trans = 0},
{fin = [(N 27),(N 37)], trans = 0},
{fin = [(N 25),(N 37)], trans = 0},
{fin = [(N 37)], trans = 15},
{fin = [(N 11)], trans = 16},
{fin = [(N 3)], trans = 0},
{fin = [(N 16),(N 37)], trans = 18},
{fin = [(N 16)], trans = 18},
{fin = [(N 13),(N 37)], trans = 20},
{fin = [(N 6)], trans = 0},
{fin = [(N 8)], trans = 0}])
end
...
let fun continue() = lex() in
 ...
 in (yybufpos := i; case yyk of 
  ...
  11 => (lineNum := (!lineNum) + 1; lex ())
| 13 => (lineNum := (!lineNum) + 1; lex ())
| 16 => (lex ())
| 19 => (Tokens.ARROW     (!lineNum, !lineNum))
| 21 => (Tokens.COMMA     (!lineNum, !lineNum))
| 23 => (Tokens.EQ        (!lineNum, !lineNum))
| 25 => (Tokens.LPAR      (!lineNum, !lineNum))
| 27 => (Tokens.RPAR      (!lineNum, !lineNum))
| 3 => (lineNum := (!lineNum) + 1; lex ())
| 30 => let val yytext=yymktext() in Tokens.VSYM (yytext, !lineNum, !lineNum) end
| 33 => let val yytext=yymktext() in Tokens.FSYM (yytext, !lineNum, !lineNum) end
| 35 => let val yytext=yymktext() in Tokens.FSYM (yytext, !lineNum, !lineNum) end
| 37 => let val yytext=yymktext() in error (yytext, !lineNum, !lineNum);
      raise LexError end
| 6 => (lineNum := (!lineNum) + 1; lex ())
| 8 => (lineNum := (!lineNum) + 1; lex ())
